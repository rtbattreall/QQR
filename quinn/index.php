<HTML><HEAD><TITLE>Quinn's Quality Reporting, Ltd.: Customer Log In</TITLE>
...
<TABLE BORDER="0" WIDTH="100%" CELLSPACING="0" CELLPADDING="0">
	...
	<TR>
		...
		<TD COLSPAN="3"></TD>
		<TD ROWSPAN="6"><IMG SRC="graphics/elephant.gif" ALT="Based in Omaha, NE" WIDTH="148" HEIGHT="149" BORDER="0"></TD>
	</TR>
	...
	<TR>
		<TD BGCOLOR="#000000" ROWSPAN="4"><IMG SRC="graphics/spacer.gif" ALT="" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
		<TD ROWSPAN="4" BGCOLOR="#FFFFFF">&nbsp;</TD>
		<TD BGCOLOR="#FFFFFF">&nbsp;<BR>
      <A CLASS="title">Customer Login</A> 
      <BR><form name="form1" method="post" action="loginps.php">
  ...
  <table width="600" border="0" cellspacing="0" cellpadding="3" align="center">
    ...
    <tr> 
      ...
      <td width="50%"> 
		...
		<TD BGCOLOR="#FF9999" ROWSPAN="4"><IMG SRC="graphics/spacer.gif" ALT="" WIDTH="2" HEIGHT="1" BORDER="0"></TD>
	</TR>

	<TR>
		<TD BGCOLOR="#FFFFFF">For more information on our HIPAA-Compliant Digital Transcription services, or to obtain a user name, please <A HREF="http://www.quinnsreporting.com/contact.htm">contact us</A> today.</TD>
	</TR>
	<TR>
